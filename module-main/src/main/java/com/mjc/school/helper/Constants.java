...
public class Constants {
    public static final String ENTER_NUMBER_OF_OPERATION = "Enter the number of operation: ";
    ...
    public static final String ID_SHOULD_BE_A_NUMBER = "%s should be a number.";
    public static final String ENTER_TAG_ID_OR_ZERO = "Enter tag id or zero: ";
